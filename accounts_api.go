 ...
 * @return *string
 */
func (a AccountsApi) CreateAccount(teamId string, firstName string, lastName string, emailAddress string, companyName string, phone string, country string, industry string, address string, city string, postalCode string, preventWelcomeEmail bool) (*string, *APIResponse, error) {
 ...
 * @param refresh Boolean for whether data returned should be from cache or not.
 * @param statisticValues Array of data that should be returned, used exclusively for cacheless data
 * @return void
 */
func (a AccountsApi) GetClientStatistics(clientId string, refresh bool, statisticValues string) (*APIResponse, error) {
	...
	for key := range a.Configuration.DefaultHeader {
		...
		queryParams.Add("clientId", a.Configuration.APIClient.ParameterToString(clientId, ""))
			queryParams.Add("refresh", a.Configuration.APIClient.ParameterToString(refresh, ""))
			queryParams.Add("statisticValues", a.Configuration.APIClient.ParameterToString(statisticValues, ""))
 ...
 * @return void
 */
func (a AccountsApi) GetUserCountry() (*APIResponse, error) {

	var httpMethod = "Get"
	// create path and map variables
	path := a.Configuration.BasePath + "/accounts/{clientId}/country"
 ...
 * @return void
 */
func (a AccountsApi) ResetApiKey() (*APIResponse, error) {

	var httpMethod = "Put"
	// create path and map variables
	path := a.Configuration.BasePath + "/accounts/apikey"
 ...
 *
 * @param profileData Profile field information for the account
 * @return void
 */
func (a AccountsApi) UpdateProfileData(profileData string) (*APIResponse, error) {

	var httpMethod = "Post"
	// create path and map variables
	path := a.Configuration.BasePath + "/account/profile/"
	...
	formParams["profileData"] = profileData
