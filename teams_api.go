 ...
 * @param orderBy How to sort the column
 * @param asc Ascending or not
 * @return void
 */
func (a TeamsApi) GetTeamPromptCampaigns(clientGroupId string, searchTerm string, orderBy string, asc string) (*APIResponse, error) {
	...
	for key := range a.Configuration.DefaultHeader {
		...
		queryParams.Add("searchTerm", a.Configuration.APIClient.ParameterToString(searchTerm, ""))
			queryParams.Add("orderBy", a.Configuration.APIClient.ParameterToString(orderBy, ""))
			queryParams.Add("asc", a.Configuration.APIClient.ParameterToString(asc, ""))
 ...
 * @return *TeamPublicRepresentation
 */
func (a TeamsApi) UpdateTeam(teamId string, name string, state string) (*TeamPublicRepresentation, *APIResponse, error) {
 ...
 * @return void
 */
func (a TeamsApi) UpdateTeamMember(teamId string, userId string, admin bool) (*APIResponse, error) {
