 ...
 * @return void
 */
func (a EmailsApi) CreatePrintingPressEmail(templateId string, content string, replace bool, videoId string, subjectLine string) (*APIResponse, error) {
