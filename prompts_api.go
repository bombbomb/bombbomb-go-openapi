 ...
 * @return *PromptBot
 */
func (a PromptsApi) CreatePromptBot(listId string, emailId string, name string, subject string, content string, contactFieldValueColumn string, botTypeId string, templateId string, videoId string, endDate string) (*PromptBot, *APIResponse, error) {
...
func (a PromptsApi) GetPromptCampaigns() (*APIResponse, error) {
	...
	var httpMethod = "Get"
	// create path and map variables
	path := a.Configuration.BasePath + "/prompts/campaigns"
 ...
 * @return *PromptBot
 */
func (a PromptsApi) UpdatePromptBot(id string, listId string, emailId string, name string, subject string, content string, contactFieldValueColumn string, templateId string, videoId string, endDate string, status string) (*PromptBot, *APIResponse, error) {
 ...
 * @param autoShares These are what we are autosharing to
 * @return void
 */
func (a PromptsApi) UpdatePromptCampaign(clientGroupId string, brandedTemplateId string, personalTemplateId string, enabled bool, autoShares string) (*APIResponse, error) {
	...
	formParams["autoShares"] = autoShares
