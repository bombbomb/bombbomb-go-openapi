 ...
 * @return void
 */
func (a PromptsApi) UpdatePrompt(id string, sendMechanism string, facebookMessage string, twitterMessage string, videoId string, emailId string, subject string) (*APIResponse, error) {
