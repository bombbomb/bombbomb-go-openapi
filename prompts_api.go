 ...
 * @param promptSubject The prompt subject.
 * @param promptBody The prompt script.
 ...
 * @return []PromptBotBot
 */
func (a PromptsApi) GetPromptBots() ([]PromptBotBot, *APIResponse, error) {
 ...
 * @param emailId The id of the video.
 * @return *VideoEmailPrompt
 */
func (a PromptsApi) RespondToVideoEmailPrompt(id string, choice string, videoId string, emailId string) (*VideoEmailPrompt, *APIResponse, error) {
 ...
 * @return *PromptBotBot
 */
func (a PromptsApi) UpdatePromptBot(id string, emailId string, endDate string, status string) (*PromptBotBot, *APIResponse, error) {
 ...
 * @return void
 */
func (a PromptsApi) UpdatePromptCampaign(clientGroupId string, brandedTemplateId string, personalTemplateId string, enabled bool) (*APIResponse, error) {
